...
import { RiArrowDownCircleLine, RiLinksLine, RiLoopLeftLine, RiProjector2Line } from "@remixicon/react";
                ...
                >
                    <div className="sm:mx-auto sm:max-w-2xl">
                        ...
                        <form action="#" method="post" className="mt-8">
                            <div className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-6">
                                ...
                                <div className="col-span-full sm:col-span-3">
                                    ...
                                    >
                                        {docTypes.flatMap((dt, i, arr) => {
                                            ...
                                            return [
                                                separator,
                                                <SearchSelectItem value={dt.id} key={dt.id}>
                                                    {dt.name}
                                                </SearchSelectItem>,
                                            ];
                                        })}
                                ...
                                <div className="col-span-full sm:col-span-3">
                                    ...
                                    <SearchSelect id="language" name="language" className="mt-2">
                                        {locales.map((l) => {
                                            return (
                                                <SearchSelectItem value={l.code} key={l.code}>
                                                    {l.name}
                                                </SearchSelectItem>
                                            );
                                        })}
                            ...
                            <Divider />
                            <Callout  className="mb-6" style={{ border: "none" }} title="Connections" color="blue">
                                To specify connections in the graph, use each dropdown to select the nodes you want to connect.
                                The dropdowns correspond to different types of connections. Simply click on a dropdown under the
                                relevant connection type (e.g., Direct, Collateral) and choose one or more nodes to establish that specific connection.
                            </Callout>
                            ...
                            <div className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2 lg:grid-cols-2">
                                ...
                                {/* Collateral Section */}
                                <div className="col-span-full sm:col-span-1">
                                    <Badge icon={RiArrowDownCircleLine} className="text-sm flex items-center gap-2">
