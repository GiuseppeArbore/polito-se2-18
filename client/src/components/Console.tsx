      ...
      <Grid numItemsLg={6} className="gap-6 mt-6">
          ...
          >
            <Col className="h-full w-full">
              <Card
                ...
                style={{ margin: 0, padding: 0, minHeight: "500px" }}
              >
            ...
            {!showSideBar && (
              <Col
                className="hider ml-2 hide-on-small ring-1 dark:ring-dark-tremor-ring ring-tremor-ring"
                role="Button"
              >
                <i
                  className="h-full text-tremor-content dark:text-dark-tremor-content"
                  onClick={() => setShowSideBar(true)}
                >
                  <RiArrowLeftSLine className="h-full" />
                </i>
              </Col>
            )}
          </div>
        ...
        <Col numColSpanLg={1}>
          <div className="flex flex-row ">
            {showSideBar && (
              <Col
                className="hider mr-1 hide-on-small ring-1 dark:ring-dark-tremor-ring ring-tremor-ring"
                role="Button"
              >
                <i
                  className="h-full text-tremor-content dark:text-dark-tremor-content"
                ...
                >
                  <RiArrowRightSLine className="h-full" />
                </i>
              </Col>
            )}
      ...
      <>
        ...
        >
          <List
            user={user}
            documents={documents}
            updateDocuments={setTmpDocuments}
